...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <h2><%: Title %>.</h2>
    <h3>Custom Orthotics for any Occasion</h3>
    <p>WORK: Great for people on their feet all day. Can be made slim for dressier work shoes or padded heavily for construction boots.
...
REFURBISH ANY OROTHOTIC: Don't worry if we didn't make it — we can refurbish your old devices to make them brand new. We can even improve their performance with slight adjustments. Call us for more information.</p>
</asp:Content>
